...
export default function HomePage() {
  ...
  // Property type insurance defaults (Richmond area typical ranges)
  ...
  const exportClosingCosts = () => {
    ...
    // Subtitle
    addText(`${realtor.fullName} | ${realtor.title}`, pageWidth / 2, yPosition, {
      fontSize: 12,
      color: grayColor,
      align: 'center'
    })
    ...
    addText(`Generated by ${realtor.fullName} - Home Buyer Consultation`, pageWidth / 2, yPosition, {
      fontSize: 9,
      color: grayColor,
      align: 'center'
    })
  ...
  const handleSubmit = async (e) => {
    ...
    const BREVO_SENDER_EMAIL = realtor.email // Must be verified in Brevo
    const BREVO_RECIPIENT_EMAIL = realtor.email // Your email to receive submissions
...
This email was sent from your website contact form via Brevo.
  ...
  return (
    <div className="landing-page">
        ...
        <div className="nav-container">
          <div className="nav-center-wrapper">
            ...
            <button
              ...
              aria-label={`${realtor.fullName} - Return to top`}
            >
              {realtor.fullName}<sup>®</sup>
            </button>
      ...
      <section className="hero">
        ...
        <div className="hero-content">
          <div className="hero-image-wrapper">
            <img 
              src={realtor.assets.headshotUrl}
              alt={`${realtor.fullName} - Expert Real Estate Agent for Home Buyers in Richmond, VA`}
          ...
          <div className="hero-trust-badge">
            ...
            <span>Licensed in Virginia • {realtor.title}</span>
          </div>
          <h1 className="hero-title">
            <span className="hero-title-line-1">Buying a home in Richmond?</span>
            <span className="hero-title-line-2">Clear steps. Fast replies.</span>
            <span className="hero-title-line-3">Local guidance from {realtor.fullName}.</span>
          </h1>
          <p className="hero-slogan">Work with a Richmond local who knows the neighborhoods, not just the listings.</p>
          <p className="hero-intro">
            {realtor.bioBullets.join(' ')} Finding your next home is a big step, and as your realtor, I'm here to make it clearer, simpler, and focused on what matters most to you. Whether you're buying your first home or your next home, let's work together to find your perfect home in the Richmond area!
          </p>
          <div className="hero-ctas" style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap', justifyContent: 'center', marginTop: '2rem' }}>
            <button className="cta-button primary" onClick={scrollToContact}>
              Get the Buyer Plan
            </button>
            <a href={`tel:${realtor.phone.replace(/\D/g, '')}`} className="cta-button secondary" style={{ textDecoration: 'none', display: 'inline-block' }}>
              Call {realtor.fullName.split(' ')[0]}
            </a>
            <a href={`mailto:${realtor.email}`} className="cta-button secondary" style={{ textDecoration: 'none', display: 'inline-block' }}>
              Email {realtor.fullName.split(' ')[0]}
            </a>
          </div>
        </div>
      </section>
      ...
      <section className="awards-proof fade-in-section" style={{ background: '#f8fafc', padding: '4rem 0' }}>
        <div className="container">
          <div style={{ textAlign: 'center', maxWidth: '800px', margin: '0 auto' }}>
            <img 
              src={realtor.assets.awardBadgeUrl} 
              alt="Award Badge" 
            ...
            />
            <h2 className="section-title" style={{ marginBottom: '1.5rem' }}>Awards & Proof</h2>
            <ul style={{ listStyle: 'none', padding: 0, marginBottom: '1rem', textAlign: 'left', maxWidth: '600px', margin: '0 auto 1rem' }}>
              {realtor.proof.map((item, index) => (
                <li key={index} style={{ padding: '0.75rem 0', fontSize: '1.1rem', color: '#1a202c' }}>
                  <span style={{ color: '#c9a961', marginRight: '0.5rem' }}>✓</span>
                  {item}
                </li>
              ))}
            </ul>
            <p style={{ fontSize: '0.9rem', color: '#64748b', fontStyle: 'italic', marginTop: '1.5rem' }}>
              Awarded by Richmond Times-Dispatch readers (2024).
            </p>
          </div>
        </div>
      </section>
      ...
      <section id="areas-served" className="areas-served fade-in-section">
        <div className="container">
          <h2 className="section-title">Areas We Serve in the Richmond Area</h2>
          <p className="section-subtitle">Licensed in Virginia - serving Richmond and surrounding areas</p>
          <div className="locations-grid">
            <div className="location-card">
              <h3 className="location-title">Richmond Area</h3>
              <ul className="location-list">
                {realtor.serviceAreas.map((area, index) => (
                  <li key={index}>
                    <button className="neighborhood-button" type="button" onClick={() => setSelectedNeighborhood(area)}>
                      {area}
                    </button>
                  </li>
                ))}
      ...
      {selectedNeighborhood && (
        <div className="neighborhood-info-modal" style={{ position: 'fixed', top: 0, left: 0, right: 0, bottom: 0, background: 'rgba(0,0,0,0.7)', zIndex: 1000, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '2rem' }}>
          <div style={{ background: 'white', padding: '2rem', borderRadius: '10px', maxWidth: '600px', position: 'relative' }}>
            <button onClick={() => setSelectedNeighborhood(null)} style={{ position: 'absolute', top: '1rem', right: '1rem', background: 'none', border: 'none', fontSize: '1.5rem', cursor: 'pointer' }}>×</button>
            <h3>{selectedNeighborhood}</h3>
            <p>Information about {selectedNeighborhood}, Virginia. Contact {realtor.fullName} to learn more about homes in this area.</p>
          </div>
        </div>
      )}
                ...
                <li>
                  ...
                  <div>
                    <div className="label-with-icon">
                      ...
                      <span className="tooltip-icon" data-tooltip="Closing Costs: Fees paid at settlement including appraisal, inspection, title insurance, loan origination, and recording fees. Typically 2.5-3% of home price in the Richmond area.">
                        <Info size={14} />
                      </span>
                    </div>
                    <span>~2.5% - 3%</span>
      ...
      <section id="closing-cost-calculator" className="closing-cost-calculator fade-in-section">
        <div className="container">
          ...
          <p className="section-subtitle">
            Estimate your total closing costs and cash needed to buy a home in the Richmond area. 
              ...
              <div className="closing-cost-breakdown">
                ...
                <div className="breakdown-list">
                  ...
                  <div className="breakdown-item">
                    <div className="breakdown-item-label">
                      <span>Appraisal</span>
                      <span className="tooltip-icon" data-tooltip="A professional assessment of the home's value by a licensed appraiser. Required by lenders to ensure the property is worth the loan amount. In the Richmond area, typically costs $400-$600+ depending on property size.">
                        <Info size={14} />
                      </span>
                    </div>
                  ...
                  <div className="breakdown-item">
                    <div className="breakdown-item-label">
                      ...
                      <span className="tooltip-icon" data-tooltip="A professional evaluation of the property's condition, including structural elements, systems (HVAC, plumbing, electrical), and safety concerns. In the Richmond area, typically costs $350-$750. Allows you to negotiate repairs or withdraw if major issues are found.">
                        <Info size={14} />
                      </span>
                    </div>
        ...
        <div className="container">
          ...
          <div className="priority-content">
            ...
            <p className="priority-text">
              Why limit your search to what's on Zillow? As a {realtor.team} client, you get exclusive access to homes NOT listed 
      ...
      <section id="team-advantage" className="team-advantage fade-in-section">
        <div className="container">
          <h2 className="section-title">Why Work With {realtor.fullName} & {realtor.team}?</h2>
          <div className="stats-grid">
            <div className="stat-card">
              <div className="stat-number">NO. 1</div>
              <div className="stat-label">Best Real Estate Agent (Richmond Times-Dispatch, 2024)</div>
            </div>
            <div className="stat-card">
              <div className="stat-number">NO. 1</div>
              <div className="stat-label">Best Real Estate Team (Richmond Times-Dispatch, 2024)</div>
            </div>
            <div className="stat-card">
              <div className="stat-number">{realtor.brokerage.toUpperCase().split(' ')[0]}</div>
              <div className="stat-label">Brokerage Partner</div>
            </div>
            <div className="stat-card">
              <div className="stat-number">LOCAL</div>
              <div className="stat-label">Richmond Expert</div>
            </div>
          </div>
          <p className="team-text">
            When you work with me as your realtor, you're working with {realtor.fullName} and {realtor.team}. {realtor.bioBullets.join(' ')} 
            <strong> Let's work together to find your perfect home in the Richmond area.</strong>
          </p>
        </div>
      </section>
      ...
      <section id="faq" className="faq fade-in-section">
        <div className="container">
          ...
          <p className="section-subtitle">Everything you need to know about buying a home in the Richmond area</p>
          <div className="faq-list">
            ...
            <div className={`faq-bar ${openFaq === 10 ? 'open' : ''}`}>
              ...
              <div className="faq-answer-content">
                <p className="faq-answer">
                  Yes! There are several first-time home buyer programs available in Virginia that can help with down payment assistance, lower interest rates, and reduced closing costs. These programs include options like FHA loans, VA loans (for eligible veterans), and state-specific programs like the Virginia Housing Development Authority (VHDA) programs. As your realtor, I'll connect you with mortgage lenders who can provide detailed information about first-time home buyer programs you may qualify for. <strong>Ask me more about first-time buyer programs in the Richmond area.</strong>
                </p>
              </div>
            </div>
            <div className={`faq-bar ${openFaq === 11 ? 'open' : ''}`}>
              <button className="faq-question-bar" onClick={() => toggleFaq(11)}>
                <span>What are the best neighborhoods for home buyers in the Richmond area?</span>
                <ChevronDown className={`faq-icon ${openFaq === 11 ? 'open' : ''}`} size={20} />
              </button>
              <div className="faq-answer-content">
                <p className="faq-answer">
                  The Richmond area offers excellent neighborhoods including {realtor.serviceAreas.slice(0, 5).join(', ')}, and more. Each area has unique character, price points, and amenities. As your realtor, I'll help you find the best neighborhood that fits your budget, lifestyle, and commute needs. <strong>Let's work together to explore the best neighborhoods for you in the Richmond area.</strong>
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="includes-content">
              <ul className="includes-list">
                ...
                <li className="includes-item">
                  ...
                  <span><strong>{realtor.team} Resources</strong> - Access to our network of trusted lenders, inspectors, and vendors</span>
                </li>
                <li className="includes-item">
        ...
        <div className="container">
          <div className="footer-content">
            <div className="footer-info">
              <p className="footer-name">{realtor.fullName} | {realtor.title}</p>
              <p className="footer-license">{realtor.officeAddress}</p>
              <div className="footer-contact">
                <a href={`mailto:${realtor.email}`} className="footer-email">{realtor.email}</a>
                <a href={`tel:${realtor.phone.replace(/\D/g, '')}`} className="footer-phone">{realtor.phone}</a>
              </div>
            </div>
            <div className="footer-logos">
              <div className="logo-placeholder">{realtor.brokerage}</div>
              <div className="logo-placeholder">{realtor.team}</div>
            </div>
      ...
      {showPhotoModal && (
        ...
        >
          ...
          >
            <img 
              src={realtor.assets.headshotUrl}
              alt={`${realtor.fullName} - Real Estate Agent`}
